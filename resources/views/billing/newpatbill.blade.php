...
<div class="tab-content" id="accountTabsContent">
    ...
    @endif
    <form method="POST" action="{{route('store.newbill')}}">
        @csrf
                          ...
                          <div class="form-group col-md-3">
                            ...
                            <div class="form-group form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="address" id="mobile" placeholder="Enter Your Mobile Number">
                                </div>
                    ...
                    <div class="card-body">
                            <div class="form-group form-row ">
                                ...
                                <div class="col-lg-5">
                                  ...
                                  <select class="form-control" name="dept_id" id="testBill">
