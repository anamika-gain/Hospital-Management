            ...
            <h6 class="d-flex align-items-center justify-content-between card-title">
                ...
                <div class="col-lg-1" style="margin: 0px; padding:0px;">
                    <div class="form-group mg-b-10-force">
                           ...
                           <button id="myBtn" type="button" class="btn btn-primary " data-toggle="modal" data-target="#modaldemo4">+ New</button>
                      </div>
                    </div>
            </h6>
        </div>
    ...
    <form id="editpatient">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newTicketModalLabel">Edit Doctor Info</h5>
              ...
              <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-row">
                        ...
                        <label for="description" class="mr-1">Employee's Name </label>
                        <input type="text" class="form-control"  id="newname" placeholder="Enter Name">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="description" class="mr-1">Employee's Designation </label>
                        <input type="text" class="form-control" id="newdesignition" placeholder="Enter Designation">
                    </div>
                </div>
                    <div class="form-row">
                    <div class="form-group col-md-6">
    ...
    $(document).on('click','.edit-employee',function(e){
        ...
        $.ajax({
            ...
            success:function(response){
                ...
                $('#edit_userid_id').val(response.employee.id);
                $('#newname').val(response.employee.name);
                $('#newgender').val(response.employee.gender);
                $('#newmobile').val(response.employee.mobile);
                $('#newrole').val(response.employee.role);
                $('#newdesignition').val(response.employee.designation);
                $('#Email').val(response.employee.email);
                $('#newaddress').val(response.employee.address);            
     ...
     $(document).on('click','.update-employee',function(e){
        ...
        var data ={
            ...
            'email': $('#Email').val(),
            'role':$('#newrole').val(),
            'designition':$('#newdesignition').val(),
