...
<script type="text/javascript">
    ...
    $(document).on('click','.edit-doctors',function(e){
        e.preventDefault();
        var user_id=$(this).val();
        $('#newTaskModal').modal('show');
        $.ajax({
            type:"POST",
            url:"/edit-doctor/"+user_id,
            success:function(response){
                $('#edit_userid_id').val(response.doctor.id);
                $('#newname').val(response.doctor.name);
                $('#newgender').val(response.doctor.gender);
                $('#newmobile').val(response.doctor.mobile);
                $('#Email').val(response.doctor.email);
                $('#newaddress').val(response.doctor.address);
                if(response.doctor.status==1){
     ...
     $(document).on('click','.update-doctors',function(e){
        $.ajaxSetup({
            headers: {
    ...
    $(document).on('click','.delete-doctors',function(e){
        $.ajaxSetup({
