            ...
            <div class="table-responsive">
                <div id="data-table_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4"><div class="row"><div class="col-sm-12 col-md-6"><div class="dataTables_length" id="data-table_length"><label>Show <select name="data-table_length" aria-controls="data-table" class="form-control form-control-sm"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> entries</label></div></div><div class="col-sm-12 col-md-6"><div id="data-table_filter" class="dataTables_filter"><label>Search:<input type="search" class="form-control form-control-sm" placeholder="" aria-controls="data-table"></label></div></div></div><div class="row"><div class="col-sm-12"><table id="data-table" class="table table-striped table-bordered dataTable" style="width: 100%;" role="grid" aria-describedby="data-table_info">
                    ...
                    <tr role="row">
                      ...
                      <th class="sorting" tabindex="0" aria-controls="data-table" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 89px;">Category</th>
                      <th class="sorting" tabindex="0" aria-controls="data-table" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 33px;">Analyzer</th>
                      <th class="sorting" tabindex="0" aria-controls="data-table" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style="width: 74px;">Status</th>
                    ...
                    <tfoot>
                        <tr><th rowspan="1" colspan="1">Id</th><th rowspan="1" colspan="1">Name</th><th rowspan="1" colspan="1">Category</th><th rowspan="1" colspan="1">Analyzer</th><th rowspan="1" colspan="1">Status</th><th rowspan="1" colspan="1">Action</th></tr>
                    </tfoot>
      ...
      <div class="modal-content">
          <div class="modal-header">
            ...
            <div class="modal-body">
              ...
              <input type="hidden" type="text"  id="edit_dept_id">
              ...
              @php
              $cat=DB::table('test_categories')->get();
              @endphp
              <div class="form-group ">
                <label for="exampleInputEmail1">Category</label>
                <select class="form-control" data-placeholder="Choose Test Category" name="cat_name" id="newcat">
              ...
              <div class="form-group">
                <label for="exampleInputEmail1">Analyzer</label>
                <input type="text" class="form-control" id="newanalyzer" aria-describedby="emailHelp" placeholder="Analyzer" >
              </div>
              <div class="col-lg-4">
                <label class="ckbox">
          ...
          <div class="modal-footer">
              ...
              <button type="submit" class="update-dept btn btn-primary">Sava</button>
              <p class="success"></p>
          </div>
            ...
            <div class="modal-dialog modal-lg" role="document">
              ...
              <form id="categoryForm">
                ...
                <div class="modal-body pd-20">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Test Department Name</label>
                    <input type="text" class="form-control" id="category_name" aria-describedby="emailHelp" placeholder="Department name" name="name">
                  </div>
                  @php
                  ...
                  <div class="form-group ">
                    <label for="exampleInputEmail1">Category</label>
                    <select class="form-control" data-placeholder="Choose Test Category" id="newcat_id">
                    <option label="Choose Category"></option>
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Analyzer</label>
                    <input type="text" class="form-control" id="category_name" aria-describedby="emailHelp" placeholder="Analyzer" name="analyzer">
                  </div>
...
<script type="text/javascript">
    $(document).ready(function() {
      ...
      function fatchdata() {
       ...
       $.ajax({
        ...
        success: function(response){
         console.log(response.depts);
         $('tbody').html("");
         $.each(response.depts,function(key,item){
        ...
        $('tbody').append('<tr role="row" class="odd">\
                ...
                <td>'+item.status+'</td>\
                <td>\
               <button type="button" class="edit-dept btn btn-info btn-sm " value="'+item.id+'">Edit</button>\
                <button type="button" class=" delete-dept btn btn-danger btn-sm delete-link" value="'+item.id+'">Delete</button>\
            </td>\
            </tr>\
        ');
        });
     ...
     $(document).on('click','.edit-dept',function(e){
      ...
      $.ajax({
        type:"POST",
        url:"/edit-dept/"+test_id,
        success:function(response){
            // console.log(response.tests);
             $('#edit_dept_id').val(response.depts.id);
             $('#newname').val(response.depts.name);
             $('#newcat').val(response.depts.cat_id);
             $('#newanalyzer').val(response.depts.analyzer);
             $('#newstatus').val(response.depts.status);
        }
     ...
     $(document).on('click','.update-dept',function(e){
        $.ajaxSetup({
    ...
    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        var data ={
            _token:'{{ csrf_token() }}',
            'name' : $('#newname').val(),
            'cat_id':$('#newcat_id').val(),
            'analyzer':$('#newanalyzer').val(),
            'status':status_n,
        }
