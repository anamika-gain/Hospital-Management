    ...
    <form id="editpatient">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newTicketModalLabel">Edit Expence Info</h5>
...
<div id="modaldemo5" class="modal fade" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-header pd-x-20">
            <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Add Expence</h6>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
        </div>
...
<script type="text/javascript">
    ...
    $(document).on('click','.edit-expences',function(e){
        e.preventDefault();
        var user_id=$(this).val();
        $('#newTaskModal').modal('show');
        $.ajax({
            type:"POST",
            url:"/edit-expences/"+user_id,
    ...
    $(document).on('click','.delete-expences',function(e){
        $.ajaxSetup({
